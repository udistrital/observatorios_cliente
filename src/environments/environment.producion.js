export const environment = {
  ...
  TOKEN: {
    ...
    SCOPE: 'openid email',
    REDIRECT_URL: 'https://observatorios.portaloas.udistrital.edu.co',
    SIGN_OUT_URL: 'https://autenticacion.portaloas.udistrital.edu.co/oidc/logout',
    SIGN_OUT_REDIRECT_URL: 'https://observatorios.portaloas.udistrital.edu.co',
  ...
  ID_TIPO_DOCUMENTO_GESTOR_DOCUMENTAL: 124
};
